package com.example.wifidirectchat.AsyncTasks;
...
@SuppressLint("NewApi") public class AbstractReceiver extends AsyncTask<Void, Message, Void>{
...
//		.addAction(0, "Remind", pIntent)
		...
		//Check if the app is in foreground or not. Display the notificatio when the app is in background
